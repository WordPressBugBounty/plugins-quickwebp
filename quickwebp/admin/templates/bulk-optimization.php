...
<div class="quickwebp-bulk">
    ...
    <div class="quickwebp-bulk-optimization-top">
        ...
        <button class="quickwebp-bulk-optimization-btn-start button button-secondary <?php echo esc_attr( $is_running ? '' : 'show' ); ?>">
            <?php esc_html_e( 'Start', QUICKWEBP_TEXT_DOMAIN ); ?>
            <div class="spinner"></div>
        </button>
    
        <button class="quickwebp-bulk-optimization-btn-stop button <?php echo esc_attr( $is_running ? 'show' : '' ); ?>">
            <?php esc_html_e( 'Stop', QUICKWEBP_TEXT_DOMAIN ); ?>
        </button>
    ...
    <div class="quickwebp-bulk-optimization-bottom">
        ...
        <div class="quickwebp-bulk-optimization-progress <?php echo esc_attr( $is_running ? 'show' : '' ); ?>">
